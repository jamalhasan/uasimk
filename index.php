...
<nav class="navbar navbar-default" style="background-color:#003fa7">
	<div class="container-fluid">
		...
		<div class="navbar-header" >
			...
			<a class="navbar-brand" ><span style="color:#ffffff">UBK/CBT</b></span><span style="color:#ffffff"><b> SMKN 1 JABON</b></span></a>
		</div>

		<!-- Collect the nav links, forms, and other content for toggling -->
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
		<li><a href="#" data-toggle="modal" data-target="#nama_folder"><span style="color:#ffffff">Settings</span></a></li>
		<?php  if ($ubahpass=="1"){?>
				<li><a href="#" data-toggle="modal" data-target="#ubahpassword"><span style="color:#ffffff">Ubah Password</span></a></li>
		<?php } if (file_exists('./e-learning/')){?>
			<li><a style="color:#ffffff" href="./e-learning/app/index.php" >e-Learning</a></li>
			<?php } ?>
		</ul>
		
		<ul class="nav navbar-nav navbar-right">
			<li ><a style="color:#ffffff" href="./login.php">Ujian Berbasis Komputer (SISWA)</a></li>
			<li><a style="color:#f0ff00" href="./panel/pages/index.php">Administrasi UBK</a></li>
...
<div style="margin-top:0px; bottom:50px; background-color:#dcdcdc; padding:7px; font-size:12px">
	...
	Modified @2017 by ITSupportSMK1JA
		<br>
    </div>
</div>
<footer>
