...
//********************* JIKA SISWA TERLAMBAT WAKTU MENGERJAAN LEBIH SEDIKIT DARI
...
.A{background-image:url(images/component/A.png);}
.B{background-image:url(images/component/B.png);}
.C{background-image:url(images/component/C.png);}
.D{background-image:url(images/component/D.png);}
.E{background-image:url(images/component/E.png);}
...
.cc-selector input:checked +.drinkcard-cc{
	background-image:url(images/component/pilih.png);
    -webkit-filter: none;
       -moz-filter: none;
            filter: none;
}
